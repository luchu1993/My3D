...
public:
    ...
    {
        return My3D::Abs(x_ * rhs.x_) + My3D::Abs(y_ * rhs.y_) + My3D::Abs(z_ * rhs.z_);
    }
    ...
    {
        return My3D::Equals(x_, rhs.x_) && My3D::Equals(y_, rhs.y_) && My3D::Equals(z_, rhs.z_);
    }
    /// Returns the angle between this vector and another vector in degrees.
    float Angle(const Vector3& rhs) const { return My3D::Acos(DotProduct(rhs) / (Length() * rhs.Length())); }
