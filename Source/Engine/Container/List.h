...
template <typename T> class List : public ListBase
    ...
    public:
        ...
        struct Iterator : public ListIteratorBase
        {
            ...
            explicit Iterator(Node* ptr) : ListIteratorBase(ptr) { }
        ...
        struct ConstIterator : public ListIteratorBase
        {
            ...
            /// Construct with a node pointer.
            explicit ConstIterator(Node* ptr) : ListIteratorBase(ptr)
            {
            }
            /// Construct from a non-const iterator.
            ConstIterator(const Iterator& rhs) : ListIteratorBase(rhs.ptr_)
            {
            }
    ...
    private:
        ...
        /// Reserve a node with initial node
