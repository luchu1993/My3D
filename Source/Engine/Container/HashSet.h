...
namespace My3D
{
    ...
    template <class T> typename My3D::HashSet<T>::ConstIterator begin(const My3D::HashSet<T>& v) { return v.Begin(); }
    template <class T> typename My3D::HashSet<T>::ConstIterator end(const My3D::HashSet<T>& v) { return v.End(); }
    template <class T> typename My3D::HashSet<T>::Iterator begin(My3D::HashSet<T>& v) { return v.Begin(); }
    template <class T> typename My3D::HashSet<T>::Iterator end(My3D::HashSet<T>& v) { return v.End(); }
}
