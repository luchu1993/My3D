...
namespace My3D
{
    ...
    public:
        ...
        /// Remove child elements of certain name, or all child elements if name is empty. Return ture if successful
        ...
        bool NotNull() const;
        /// Return true if refers an element or an XPath node
